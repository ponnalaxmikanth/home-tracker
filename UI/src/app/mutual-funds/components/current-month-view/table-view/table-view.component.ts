...
export class TableViewComponent implements OnInit {
  ...
  constructor() {
    this.cols = [
      ...
      { field: 'folioNumber', header: 'Folio Number', type: 'string', class: 'folio-number', filter: false, display: true },
      // { field: 'schemaCode', header: 'Schema Code', type: 'String', class: 'schema-code', filter: false, display: true },
      { field: 'schemaName', header: 'schema Name', type: 'String', class: 'schema-name', filter: false, display: true },
      { field: 'isin', header: 'ISIN', class: 'isin', filter: false, display: true },
      { field: 'targetAmount', header: 'Target', class: 'target-amount', filter: false, display: true },
      { field: 'investment', header: 'Invest', class: 'number investment', filter: false, display: true },
      { field : 'investmentPer', header: 'Invest (%)', class: 'investment-percent number', filter: false, display: true },
      { field: 'remainingAmount', header: 'Remaining', class: 'remaining-amount number', filter: false, display: true },
